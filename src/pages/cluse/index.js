    ...
    return (
      <div className="cluse">
        ...
        <div id="p1">
          ...
          <Paragraph paragraphTitle="Contrast Subtleties" 
          ...
          <ImgRight img={Fig9} imgNum="09" imgCaption="Proposed contrast checking workflow with the use of a built-in design accelerator."/>
          ...
          <ImgRight img={Fig10} imgNum="10" imgCaption="Testing Stark's website with Stark."/>
